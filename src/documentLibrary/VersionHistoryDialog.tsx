...
import type { DocumentLibraryGraphClient, DocumentLibraryVersion } from './types'
              ...
              >
                <Box>
                  <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
                    {v.comment ? v.comment : `Version ${v.id}`}
                  </Typography>
                  <Typography variant="body2" color="text.secondary">
                    Created: {formatDate(v.createdDateTime)}
                  </Typography>
                  {v.lastModifiedDateTime ? (
                    <Typography variant="body2" color="text.secondary">
                      Modified: {formatDate(v.lastModifiedDateTime)}
                    </Typography>
                  ) : null}
                </Box>
                <Button
